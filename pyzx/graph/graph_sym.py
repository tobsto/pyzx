...
from ..utils import VertexType, EdgeType, FloatInt, FloatInt

from typing import Union

from sympy import Symbol
SymbolLike = Union[Symbol,int]

class GraphSym(BaseGraph[int,Tuple[int,int]]):
    """Graph with symbolic phases of :class:`~graph.base.BaseGraph`."""
    backend = 'symbolic'
    ...
    def __init__(self):
        ...
        self._phase: Dict[int, SymbolLike]            = dict()
